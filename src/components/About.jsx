...
function About() {
  return (
    <section className="container mx-auto px-4 py-16 h-full flex flex-col justify-center">
      ...
      <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-start bg-white dark:bg-zinc-800 border-4 border-black shadow-neo-lg p-6 lg:p-10">
        <div className="w-full max-w-xs lg:w-1/3 flex-shrink-0">
          <div className="overflow-hidden border-4 border-black shadow-neo transition-transform duration-300 hover:-translate-y-1 hover:translate-x-1">
            <img
